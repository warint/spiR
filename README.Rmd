...
[![CRAN status](https://www.r-pkg.org/badges/version/spiR)](https://CRAN.R-project.org/package=spiR)
...
To see a definition of the indicators, please visit this [page](https://www.socialprogress.org/index/global/definitions/#BHN/0/0/){target="_blank"}. 
...
Users can recreate in R impactful dashboards and visualizations as the ones found on [www.socialprogress.org](https://www.socialprogress.org/){target="_blank"}: [click here](https://www.socialprogress.org/?tab=2&code=NOR&embedded=true/){target="_blank"}
...
If you use the spiR package for research, education, policymaking or other related purposes, please cite the package as well as the Social Progress Imperative. Consider making them a donation to help them pursue the work. Business, social enterprises and investors interested in using the Social Progress Index should contact their offices.
